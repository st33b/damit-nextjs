...
1. Averages &amp; Scores:
   ...
   1. Averages will be verified on the [www.bowl.com](http://www.bowl.com) database. A correct USBC number must be provided on the entry form. Any averages that are unavailable or inaccurate on this site must be noted in the comments section of the entry form, with separate verification provided by the league secretary (letter or standing sheet). It is the entrant's responsibility to supply complete and accurate information.
